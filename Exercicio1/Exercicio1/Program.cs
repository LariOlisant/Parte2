...
funcionario func2 = new funcionario { nome = "Amor", idade = 25 };
...
funcionario func6 = new funcionario { nome = "Joelma", idade = 41 };

func6.AguaDaVida(15);

funcionario func7 = new funcionario { nome = "Mariana", idade = 30 };

func7.Envelhecer(15);

funcionario func8 = new funcionario { nome = "Adilson(sogro)", idade = 25 };

func8.Envelhecer(5);

funcionario func9 = new funcionario { nome = "Josi(sogra)", idade = 40 };

func9.Envelhecer(10);

funcionario func10 = new funcionario { nome = "Hugo", idade = 30 };
...
//encerra o programa 
Console.WriteLine("Ieiii! Acabamos ");
Console.ReadKey();